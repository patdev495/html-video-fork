...
const DICT = {
  en: {
    ...
    'toolbar.agent': 'Agent',
    'toolbar.model': 'Model',
    'toolbar.content_language': 'Video language',
    'toolbar.agent_none': '— none —',
    'toolbar.agent_ready': '● ready',
    'toolbar.agent_install': '○ install',
    'toolbar.export_mp4': 'Export MP4',
    'content_language.auto': 'Auto',
    'content_language.current': 'Current: {language}',
    'content_language.target': 'Target: {language}',
    'content_language.translate': 'Translate to {language}',
    'content_language.target_set': 'Video language target: {language}',
  ...
  zh: {
    ...
    'toolbar.agent': 'Agent',
    'toolbar.model': '模型',
    'toolbar.content_language': '视频语言',
    'toolbar.agent_none': '— 无 —',
    'toolbar.agent_ready': '● 就绪',
    'toolbar.agent_install': '○ 待装',
    'toolbar.export_mp4': '导出 MP4',
    'content_language.auto': '自动',
    'content_language.current': '当前：{language}',
    'content_language.target': '目标：{language}',
    'content_language.translate': '翻译为 {language}',
    'content_language.target_set': '视频目标语言：{language}',
